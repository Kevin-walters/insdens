...
![Required format of the input csv file](csv_file_image.png)
...
```{r, realdata,include=FALSE}
# Three csv files containing the insertion densities for E.coli, S.aureus and S.Typhimurium are available with the package at

system.file("extdata", "E_coli_insdens.csv", package = "insdens")
system.file("extdata", "S_aureus_insdens.csv", package = "insdens")
system.file("extdata", "S_Typhimurium_insdens.csv", package = "insdens")
```
